...
import (
	...
	modulev1 "github.com/LiHaixin000/blockchain/api/blockchain/blockchain"
)
		...
		Tx: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				...
				},
				{
					...
					Use:            "create-resource [name] [data]",
					Short:          "Create resource",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "name"}, {ProtoField: "data"}},
				},
				{
					RpcMethod:      "UpdateResource",
					Use:            "update-resource [id] [name] [data]",
					Short:          "Update resource",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "id"}, {ProtoField: "name"}, {ProtoField: "data"}},
				},
				{
